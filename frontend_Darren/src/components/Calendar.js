...
import { fetchEvents, addEvent, updateEvent, deleteEvent } from "../features/eventSlice";
...
const Calendar = () => {
  ...
  return (
    <div className={`p-6 min-h-screen ${darkMode ? "bg-gray-900 text-white" : "bg-gray-300 text-black"}`} 
    style={{
