...
const liveColEditor = () => {
  ...
  useEffect(() => {
    ...
    socket.on("load-document", (content) => {
      console.log("Loaded document from server:", content);
    ...
    const handleUpdate = () => {
      const content = editor.getHTML(); // ✅ Store value in a variable first
      console.log("Sending changes to server:", content);
      socket.emit("send-changes", content); // ✅ Emit only once
    };
